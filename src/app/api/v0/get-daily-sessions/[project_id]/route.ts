...
async function getDailySessions(projectId: string, config_name?: string) {
    ...
    let response = await client.rpc("daily_active_sessions", params);
...
export async function GET(req: Request, res: Response) {
    try {
        ...
        const data = query.config_name ? await getDailySessions(projectId, query.config_name) : await getDailySessions(projectId);

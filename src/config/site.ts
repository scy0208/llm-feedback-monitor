...
export const siteConfig: SiteConfig = {
  name: "LLM Feedback",
  description:
    "Easily integrate user feedback widget and text analysis module into your Conversational AI application, and evolve it with insights from user interation.",
  url: "https://llmfeedback.com",
  ogImage: "https://d2aaddunp29031.cloudfront.net/og.jpg",
  links: {
